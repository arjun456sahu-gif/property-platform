...
//                 className="ml-3 w-full bg-transparent text-sm outline-none placeholder:text-black-400"
//               />
//             </div>
//           </div>
...
//                 className="ml-3 w-full bg-transparent outline-none placeholder:text-black-400"
//               />
//             </div>
          ...
          <div className="hidden flex-1 items-center justify-center px-8 md:flex">
            <div className="flex w-full max-w-lg items-center rounded-full border border-gray-200 bg-gray-50 px-4 py-2 shadow-inner transition-all focus-within:border-blue-500 focus-within:bg-white focus-within:ring-2 focus-within:ring-blue-100">
              ...
              <input
                type="text"
                placeholder="Search by location, property type..."
                // FIXED: Added text-gray-900 for typed text, and valid placeholder color
          ...
          <div className="space-y-4 px-4 pb-6 pt-4">
            ...
            <div className="flex items-center rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 focus-within:border-blue-500 focus-within:bg-white">
              ...
              <input
                type="text"
                placeholder="Search properties..."
                // FIXED: Added text-gray-900 for typed text
                className="ml-3 w-full bg-transparent text-gray-900 outline-none placeholder:text-gray-500"
              />
            </div>
            
            {/* Mobile Navigation Links */}
            <div className="flex flex-col gap-1">
              <Link href="/wishlist" className="flex items-center gap-3 rounded-md px-3 py-3 text-base font-medium text-gray-700 hover:bg-red-50 hover:text-red-600" onClick={() => setIsOpen(false)}>
                <Heart className="h-5 w-5" /> My Wishlist
              </Link>
              <Link href="/profile" className="flex items-center gap-3 rounded-md px-3 py-3 text-base font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600" onClick={() => setIsOpen(false)}>
                <UserCircle className="h-5 w-5" /> Profile & Settings
              </Link>
            </div>
